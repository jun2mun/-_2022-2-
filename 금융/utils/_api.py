...
def yahoo_api(STOCK_CODE,start='2020-01-01', end='2021-12-01'):
    ...
    STOCK = yf.download(STOCK_CODE, #삼성전자주 코드
                start=start, end=end)
...
def pandas_datareader_api_v1(STOCK_CODE,api_web='yahoo',start='2020-01-01',end='2021-01-01'):
    ...
    STOCK = web.DataReader(STOCK_CODE, api_web, start, end)
